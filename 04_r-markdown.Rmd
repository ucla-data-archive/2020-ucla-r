...
* Having the code, analysis and output in one document that is runable helps
...
* `knitr` lets you to mix basically any sort of text with code from different programming languages, but we recommend that you use `R Markdown`, which mixes Markdown
with R. 
