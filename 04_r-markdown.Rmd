...
* Beginners often write R scripts 
* Emailing scripts & graphs
* Can be problematic and cumbersome 
* writing reports in Word or [LaTeX](http://www.latex-project.org/) can incoporate analysis and ouput graphs together
* But tweaking report and parameters can be difficult, "whack a mole" fixing mistakes in code then report, copy paste.
* Having web page using R Markdown helps
* Changing formatting or analysis is much easier and easier to reproduce

## Literate programming

* Ideally analysis reports are _reproducible_ documents: 
* If an
...
* The key R package is [`knitr`](http://yihui.name/knitr/). 
   * It allows you to create a document that is a mixture of text and chunks of
code. 
...
* You can use the header to give your document a title, author, date, and tell it that you're going to want
...
* Markdown is a system for writing web pages by marking up the text with symbols like asterick, pound, underscore 
* The marked-up text gets _converted_ to html, replacing the marks with the proper html code.

* To see how this work let's delete all of the dummy text that was generated when we created the rmarkdown document and write some markdown. 
* To make things **bold** using two asterisks around what you want to bold, like this: `**bold**`, and you make things _italics_ by using underscores, like this:
`_italics_`.
